...
> Python code to complete the [freeCodeCamp - Port Scanner](https://www.freecodecamp.org/learn/information-security/information-security-projects/port-scanner) challenge. Also available on [replit](https://replit.com/@browun/boilerplate-port-scanner#main.py).
